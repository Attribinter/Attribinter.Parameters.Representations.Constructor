...
public sealed class LoweringMethodParameterRepresentationFactory
    : IParameterRepresentationFactory<IMethodParameter, IMethodParameterRepresentation>
{
    ...
    public LoweringMethodParameterRepresentationFactory(
    ...
    IMethodParameterRepresentation IParameterRepresentationFactory<IMethodParameter, IMethodParameterRepresentation>.Create(
